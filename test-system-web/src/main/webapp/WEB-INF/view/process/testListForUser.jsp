...
<div>
    <div class="links">
        <a href="Controller?action=home"><span class="more nowrap">User main page</span></a>
        <a href="Controller?action=result_list"><span class="more nowrap">Investigate Results</span></a>
